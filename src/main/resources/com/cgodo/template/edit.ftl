...
overrideName="title"]修改${remark} [/@override] [@override overrideName="links" ]
...
<div class="main-content-inner">
	<div class="breadcrumbs ace-save-state" id="breadcrumbs"
		...
		<ul class="breadcrumb">
			...
			<li><i class="ace-icon"></i> <a
				href="[@s.url '/admin/${tableName}/edit.html?id=${r"${form.id}"}'/]">修改${remark}</a></li>
		</ul>
	</div>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal form-validate"
				action="[@s.url '/admin/${tableName}/edit.jhtml?format=json'/]"
