 ...
 */
public class AdminActMake extends Make {
...
//		}
		...
		imports.add(getMakeInfo().getBasePackage() + ".admin.act.form."
	...
	public void hander(Map<String, Object> dataMap)
		...
		handler.setFileName("admin_act.ftl");
		handler.setSavePath(GeneratorApplication.getSaveJavaBasePath() + "/admin/act/");
